...
import { registerRandomEventTrigger, unregisterRandomEventTrigger } from "../events/autorandom/RandomEventTrigger";
import { AttackTarget } from "../exploration/AttackTarget";
import { CombatStat } from "../exploration/CombatStats";
import { addEnemyDeathListener, aoeEnemyAttackEffect, calculateAttackTarget, calculateDamage, calculateIsHit, dispelAllEnemyAttackEffect, drainingEnemyAttackEffect, drainingSummonAttackEffect, fractionAoEEnemyAttackEffect, fractionEnemyAttackEffect, getCurrentDungeonFloor, getCurrentEnemyHPFraction, getCurrentFamiliarAction, getCurrentFamiliarHPFraction, getCurrentHPFromTarget, getCurrentPlayerHPFraction, getEnemyTurnCounter, getStatFromTarget, getSuccessfulExplorationsForFloor, modifyTargetCurrentHP, pierceDefenseAoEEnemyAttackEffect, pierceDefenseEnemyAttackEffect, standardEnemyAttackEffect, standardFamiliarAttackEffect, standardPlayerAttackEffect, startCombat, triggerCombatLoss } from "../exploration/Exploration";
...
export declare const MR2: {
    ...
    addEnemyDeathListener: typeof addEnemyDeathListener;
