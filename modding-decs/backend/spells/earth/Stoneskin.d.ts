...
declare class StoneskinTemporaryEffect extends TemporaryEffect {
    getId(): string;
...
declare const temporaryEffect: StoneskinTemporaryEffect;
declare class Stoneskin extends CombatSpellBase {
    getId(): string;
    getSpellName(): string;
...
declare const stoneskin: Stoneskin;
