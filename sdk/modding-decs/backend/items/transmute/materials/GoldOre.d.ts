...
declare class GoldOre extends Item {
    getId(): string;
    getTags(): ItemTagEnum[];
    getPicture(): any;
...
export declare const goldOre: GoldOre;
declare class TransmuteGoldOre extends TransmutationSpell {
    getItem(): Item;
...
export declare const transmuteGoldOre: TransmuteGoldOre;
export {};
