...
declare class MagicCloth extends Item {
    getId(): string;
    getTags(): ItemTagEnum[];
    getPicture(): any;
...
export declare const magicCloth: MagicCloth;
declare class TransmuteMagicCloth extends TransmutationSpell {
    getItem(): Item;
...
export declare const transmuteMagicCloth: TransmuteMagicCloth;
export {};
